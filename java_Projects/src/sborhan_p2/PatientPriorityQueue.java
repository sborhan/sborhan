...
public class PatientPriorityQueue {
   ...
   //***** All class methods *****
     ...
     * checking if second parameter has Higher Priority 
     * @param smallerChildIndex : Integer
     * @param index : Integer
     * @return boolean :return true if smallerChildIndex has Higher Priority
     */
   ...
   /**
    * helper method swap
    * swapping the values of two parameters
    * @param indexOne : Integer
    * @param indexTwo : Integer
    */
    ...
    * @param parentIndex : Integer
    * @return integer:represents right patient index
    */
   ...
   * @param parentIndex : Integer
   * @return integer:represents left patient index
   */
